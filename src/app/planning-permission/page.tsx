...
const jsonLd = {
  ...
  "@type": "Service",
  "@id": `${BASE_URL}/planning-permission#service`,
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Full Planning Permission" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Householder Applications" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Change of Use Development" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Listed Building Consent" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Retrospective Planning Applications" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Planning Appeals" } },
    ],
  },
};
